...
class DashboardDepartemenController extends Controller
{
    public function dashboardDepartemen(Request $request)
    {
        if (Auth::user()->role_id === 4) {
            ...
            if ($departemen) {
                return view('departemen.dashboard', ['departemen' => $departemen, 'mahasiswas' => $mahasiswas, 'mahasiswasSkripsi' => $mahasiswasSkripsi, 'angkatan'=>$angkatan,'result'=>$result,'angkatan2'=>$angkatan2]);
            }
        }
