            ...
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Status Recap</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="items-center justify-between lg:flex">
            ...
            <div class="items-center sm:flex">
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <a href="{{route('DoswalPreviewStatus')}}"
                            ...
                            <tbody class="bg-white dark:bg-gray-800">
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <a href="{{route('daftarstatusdoswal',['angkatan'=>$angkatan,'status'=>'active'])}}"
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="border-r text-center p-4 text-sm font-semibold text-blue-500 whitespace-nowrap dark:text-blue-500">
                                        <a href="{{route('daftarstatusdoswal',['angkatan'=>$angkatan,'status'=>'lulus'])}}"
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="border-r text-center p-4 text-sm font-semibold text-blue-500 whitespace-nowrap dark:text-blue-500">
                                        <a href="{{route('daftarstatusdoswal',['angkatan'=>$angkatan,'status'=>'do'])}}"
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="border-r text-center p-4 text-sm font-semibold text-blue-500 whitespace-nowrap dark:text-blue-500">
                                        <a href="{{route('daftarstatusdoswal',['angkatan'=>$angkatan,'status'=>'meninggal_dunia'])}}"
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="border-r text-center p-4 text-sm font-semibold text-blue-500 whitespace-nowrap dark:text-blue-500">
                                        <a href="{{route('daftarstatusdoswal',['angkatan'=>$angkatan,'status'=>'cuti'])}}"
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="border-r text-center p-4 text-sm font-semibold text-blue-500 whitespace-nowrap dark:text-blue-500">
                                        <a href="{{route('daftarstatusdoswal',['angkatan'=>$angkatan,'status'=>'undur_diri'])}}"
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="border-r text-center p-4 text-sm font-semibold text-blue-500 whitespace-nowrap dark:text-blue-500">
                                        <a href="{{route('daftarstatusdoswal',['angkatan'=>$angkatan,'status'=>'mangkir'])}}"
