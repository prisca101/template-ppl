                        ...
                        <ul class="pb-2 space-y-2">
                            ...
                            <li>
                                <a href="{{route('perwalian')}}"
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">Perwalian</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{route('showAll')}}"
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">Verification</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="/listpkl"
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">PKL List</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="/listskripsi"
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">Skripsi List</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="/RekapPKL"
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">PKL Recap</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="/RekapSkripsi"
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">Skripsi Recap</span>
                                </a>
                            </li>
