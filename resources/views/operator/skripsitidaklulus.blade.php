...
@section('content')
    <div class="mb-4 col-span-full xl:mb-2">
        ...
        <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Daftar Tidak Lulus Skripsi Mahasiswa Informatika</h1>
    </div>
...
<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    ...
    <div class="items-center justify-between lg:flex">
        ...
        <div class="items-center sm:flex">
                ...
                <a href="{{ route('OperatorListSkripsiTidakLLulus', ['angkatan' => $angkatan, 'status' => 'pending']) }}" target="_blank" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700 mr-5">
