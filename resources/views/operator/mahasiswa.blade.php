...
@section('content2')
    <div class="sm:flex">
        ...
        <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
            ...
            <button type="button" data-modal-toggle="import-user-modal"
    ...
    <div
        class="pt-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
