            ...
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Detail Mahasiswa</span>
                    </div>
                </li>
            </ol>
        </nav>
                                        ...
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap">
                                                ...
                                                <div class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-pink-500 rounded-lg hover:bg-pink-600 focus:ring-4 focus:ring-pink-300 dark:focus:ring-pink-900">
                                                    <a href="{{route('detailMhs',['nim'=>$mahasiswa->nim])}}" class="flex items-center justify-center w-auto">
