...
<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    ...
    <div class="items-center justify-between lg:flex">
        ...
        <div class="items-center sm:flex">
                ...
                <a href="{{ route('PreviewListPKLLulus', ['angkatan' => $mahasiswas[0]->angkatan, 'status' => 'verified']) }}" target="_blank" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700 mr-5">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                        ...
                        <tbody class="bg-white dark:bg-gray-800">
                            ...
                            <tr>
                                ...
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    {{$mahasiswa->tanggal_sidang}} <!-- menambahkan tanggal_sidang -->
                                </td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    {{$mahasiswa->lama_studi}} <!-- menambahkan lama_studi -->
                                </td>
                            </tr>
                            @endforeach
