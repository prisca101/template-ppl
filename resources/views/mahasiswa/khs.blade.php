            ...
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">KHS</span>
                    </div>
                </li>
            </ol>
        </nav>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-normal text-gray-500 truncate dark:text-gray-400">
                                    {{ $IPKumulatif }} / {{ $JumlahSKSKumulatif }} SKS
                                </p>
                            </div>
                        </div>
                    </li>
    ...
    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        ...
        <div class="items-center justify-between lg:flex">
            <div class="mb-4 lg:mb-0">
                <h3 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Daftar KHS</h3>
            </div>
                                    ...
                                    @foreach ($khsData as $khs)
                                        <tr>
                                            <td
                                                ...
                                                <span class="font-semibold">{{ $khs->semester_aktif }}</span>
                                            </td>
                                            <td
                                            ...
                                            <td class="p-4 whitespace-nowrap">
                                                <span
                                                    class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-green-400 border border-green-100 dark:border-green-500">{{ $khs->status }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
