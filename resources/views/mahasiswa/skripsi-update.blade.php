...
@section('content')
    ...
    <div class="col-span-2">
        <div
            ...
            <form action="{{ route('skripsi.updateSkripsi', ['semester_aktif' => $mahasiswa->semester_aktif]) }}" method="post"
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <select id="semester_aktif" name="semester_aktif"
                            ...
                            <option selected disabled value="{{ $mahasiswa->semester_aktif }}">
                                {{ $mahasiswa->semester_aktif }}</option>
                        </select>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="nilai"
                        ...
                        <select id="nilai" name="nilai"
                            ...
                            <option value="E" {{ $mahasiswa->nilai == 'E' ? 'selected' : '' }}>E</option>
                        </select>
                        @error('nilai')
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <select id="lama_studi" name="lama_studi"
                            class="bg-gray-50 border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            @for ($i = 3; $i <= 7; $i++)
                                <option value="{{ $i }}" {{ $mahasiswa->lama_studi == $i ? 'selected' : '' }}>
                                    {{ $i }}</option>
                            @endfor
                        </select>
                        @error('lama_studi')
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <div class="relative">
                            ...
                            <input datepicker datepicker-format="yyyy-mm-dd" type="text" name="tanggal_sidang"
                                id="tanggal_sidang"
                                ...
                                placeholder="Select date" value="{{ $mahasiswa->tanggal_sidang }}">
                        </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="scanSkripsi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Scan
                            Skripsi</label>
                        <input type="file" value="{{ $mahasiswa->scanSkripsi }}"
