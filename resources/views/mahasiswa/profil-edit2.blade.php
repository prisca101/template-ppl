...
@section('content')
    ...
    <div class="col-span-full xl:col-auto">
        <div
            ...
            <form action="{{ route('mhs.update2', [Auth::user()->id]) }}" method="POST"
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="relative inline-block">
                            <input type="file" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" id="foto" name="foto"
                        accept=".jpg, .jpeg, .png" />
                            <button type="button"
        ...
        <div
            ...
            <h3 class="mb-4 text-xl font-semibold dark:text-white">General information</h3>
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="kabkota" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kabupaten/Kota</label>
            ...
            <h3 class="mb-4 text-xl font-semibold dark:text-white">Password information</h3>
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input data-popover-target="popover-password" data-popover-placement="bottom" type="password" id="new_password"
                            name="new_password"
